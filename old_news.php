...
<blockquote>
<div align=\"center\">
<br /><br /><p>Back to <a href=login_form.php>Login</a>
</div>

The following contains news items from 30 Nov 1999 up to March 2002. Perhaps they are little more than a curiousity but reading through them briefly can fill you in on some blanks as to how SE reached it's current design. This news was gathered from a number of servers over time:
...
<br /> - Shows when a clan-mate is online. This can be seen in your clans info page. This function only excists for clan-mates, not for all players in general (and it won't either).
...
<li> And of course not to forget the already excistant BlackHole, which some players have already had the "pleasure" of experiancing :).
<p><b>Other changes</b>:
...
<br />Will add to an excisting bounty, or create a new one.
