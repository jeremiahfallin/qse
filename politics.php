...
db(__FILE__,__LINE__,"select timestamp,position_id,login_name,login_id from ${db_name}_politics where login_id > '0' order by login_id");
$polit = dbr();
if ($polit) {
