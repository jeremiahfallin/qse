...
// Checks the nth radio buttons in the given form
function CheckRadioButtons( form_name, name_prefix, which ) {
	var alpha = eval( "document." + form_name );
	var lastname = '';
	var count = 0;
	var index = 0;
	for ( index = 0; index < alpha.elements.length; index++ ) {
		var name = alpha.elements[index].name;
