...
Objective:			install init file - executes all startup procedures before accessing each PHP file in Install
...
$this_version = "QS Generations: 0.7.2";
$app = "Quantum Star SE";
...
// create a new template Object (using default install theme as example)
