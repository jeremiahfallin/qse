...
<p><small>Originally written by Patrick Brady (aka Maugrim the Reaper). Edited and slightly abridged by Moriarty.</small>";
#delta bomb story
$story['Delta_Bomb_Blueprints_Disappear'] = "In breaking news today we have learnt of a new threat to the (in)stability of the galaxy. The Corporation known as Heavy Weapons Inc. has reported the theft of a set of blueprints for a new bomb they have been developing.
<p>Investigators believe the theft was conducted by a small militia group called Liberation for Sol for a third party, however they have no idea who the third party is at present. They fear that the new owners of the blueprints will use them to build the bombs, and then sell them via Bilkos to the highest bidder.
<p>The Bomb - which has the production name Delta - was developed for the military, with the specific purpose of being used to target large warfleets. Though Heavy Weapons Inc. refuse to discuss the capabilites of the bomb, they have released a statement saying it \"has the potential to cause major damage if gets into the wrong hands.\"

<br /><br /><br />Written 27-Jan-2002 by Moriarty";
...
$story['New_Ships_Spotted_at_Blackmarkets'] = "Those insidous hives of roguery and brigandage are now also home to two new ship designs.<br />At least thats what un-official reports from undercover officers who have infiltrated the pirate networks say. The reports, though patchy, allow an impression of the ships capabilities and purposes to be given.<br /><br />The first goes by the production-name Occultator, and is reported to be the shell of an asteroid which has been filled with fighter bays. The reports neglect to state the purpose the ship was designed for, however from what has been uncovered, it seems likely the ship - if it can be called that - would be ideal for eliminating planets. The name given to the ship (Occultation meaning The process of an asteroid blocking star-light from going to the planet below) only strengthens this theory.
<p>The second ships is simply called Gunboat. All that is known of this ship is that it is small, fast, and outfitted with enough alien technology as to allow it to be a significant threat to merchant shipping.
